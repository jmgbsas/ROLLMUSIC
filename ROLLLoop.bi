...
Sub creaPenta (c As cairo_t Ptr, Roll as inst )
     ...
     If *po = desde And COMEDIT=LECTURA And (playb=NO AND Cplay=NO And play=NO And deltaz=0 )Then ' termino 9 octavas o la NA y ahora  + ayuda...
          ...
          t = "Entrar Notas Click en [Edicion] en , otro Click en Edit para modificar, otro Click en Edit deja de editar,ESC TERMINA LA APP"
          ...
          t = "En el  algunos funcionan con Ctrl-clik otros con click solamente o ALT"
     ...
     If  COMEDIT<>LECTURA Then
          If ArmarMenuModif=TRUE   Then
               If  COMEDIT=MODIFICACION_INSERCION  Then 'solo ctrl-m
                    'print #1,".............SUBRUTINA........................................."
                    'print #1,"(9) ESTADO MUESTRA  COMANDOS"
                    'print #1,"ArmarMenuModif=TRUE  And COMEDIT=TRUE And (cursorVert = 1 or  cursorHori = 1 )"
...
Sub barrePenta (c As cairo_t Ptr, Roll as inst  )
     ...
     For i = desde To hasta ' 3 a 8 por omision
          ...
          '' ScreenSync ' a ver si aca es mejor....
             'If (Timer -  tiempoUltimoFrame) >= 0.016  Then
     ...
     Do ' nro 1 1182 TERMINA EN 7538 O FINMAIN1 
          ...
          Do  ' do nro 2 O FIN LOOP2
               ...
               If (pulsotab=1 Or pulsotab =-1) And (instancia=ARG0_EN_LINEA Or instancia= ARG107_FICTICIO) And CANCIONCARGADA   Or clickpista=1   Then
                    ...
                    Print #1,"PULSOTAB ES 1 LLAMA A TABTAB"
                    ' - 1: lowest
               ...
               'If MultiKey(SC_CONTROL) And MouseButtons And 1  Then ' modificar con X o insertar con Insert y I
               ' If COMEDIT<>LECTURA Then
               '    COMEDIT=MODIFICACION_INSERCION
               ' EndIf
               ...
               If MultiKey(SC_ALT) And MultiKey(SC_E) Then ' edicion Roll
                    ...
                    If COMEDIT<>LECTURA Then
                         ...
                         'If CANCIONCARGADA=TRUE Then ''13-05-2026 tratamos de remedar una edicion aislada sin cancion
                         '   MaxPos=pmTk(ntk).MaxPos ''13-05-2026
                         '   posn=MaxPos-6  ''13-05-2026
                         'EndIf
                    End If
                    agregarNota = AGREGAR
                    menuMouse = 0
           ...
           ''' NO ES ESTO cambiadur = 1 ' CTRL-N DEJODE FUNCIONAR VEMOS SI SE ARREGLA CON ESTO   
               ...
               If COMEDIT<>LECTURA Then ' ingreso de notas
                    ...
                    If MultiKey(SC_CONTROL) And MultiKey(SC_A)  Then ' A# Bb
                         ...
                         Exit Do
                    End If
                    'If MultiKey(SC_BACKSPACE) And COMEDIT=ENTRADA_NOTAS And backspaceNotas=0 Then ' BORRAMOS LA ULTIMA NOTA ENTRADA O FINAL DE SECUENCIA
                    'Print #1,"backspace la puta que te pario debe ser 0   ";backspaceNotas
                    '   backspaceNotas=1
                    '      Print #1,"ENTRA A LA MIERDA "
                    '      BorrarUltimaNotaEntrada()
                    '   Exit Do
                    'EndIf   no funca por ahora
                    ...
                    Case "B"
                         ...
                         If COMEDIT=SOLO_MODIFICACION Then
                              agregarNota = NO_AGREGAR
                         End If
                         ''puedo borrar pero al entrar de nuevo anda para la mierda
                         ...
                         ''' Track(ntk).trk
                         '   Sleep 10
                         '   If  backspaceNotas=0 Then ' BORRAMOS LA ULTIMA NOTA ENTRADA O FINAL DE SECUENCIA
                         ''Print #1,"backspace la puta que te pario debe ser 0   ";backspaceNotas
                         '      backspaceNotas=1
                         ''      Print #1,"ENTRA A LA MIERDA "
                         '      BorrarUltimaNotaEntrada()
               ...
               Do '''LOOP DE LECTURA DE BUFFER 11-06-2026
                    ...
                    If COMEDIT=ENTRADA_NOTAS  And nota > 0 And agregarNota=AGREGAR  And carga=0 And nota <=182   Then ' 182 entra el fin de archivo
                         ...
                         Print #1,"------NUCLEO ENTRANDO NOTA-----------------------------------------------------DUR---", DUR
                         ...
                         NuevaCancion=SI ''15-05-2026 los efectos no van debo sacarlo
                         ...
                         If menuOldStr ="[GEN]" Then ' GENERA UNA SECUENCIA ALEATORIA
                              ...
                              COMEDIT=LECTURA
                         End If
                         '' Print #1,"NUCLEO empieza posn, posnOff ";posn; " ";posnOff
                         If posn=0 Then ''+posnOff ''InicioDeLectura
                              posn=2
                         Else ' esto no estaba en 383
                         ...
                         If estoyEnOctava <> 99  And octavaEdicion = estoyEnOctava Or (GrabarPenta=1 And DUR >0 )Then ' estoy en una octava
                              ...
                              If pasoZona1 > 0 Then ''15-05-2026
                                   ''     Print #1,"posn que venia "; posn
                                   posn=pasoZona1
                                   NuevaCancion=SI ''SACAMOS EFECTOS QUE CANCELA
                              ...
                              If nota > 0 And estoyEnOctava < 99 And estoyEnOctava >=1  Or (GrabarPenta=1 And DUR >0 ) Then
                                   ...
                                   Do ' nota es semitono ahora va de 0 a 11 debo restar 1 a nota
                                        ...
                                        '' Print #1,"NUCLEO posn,(12-nota +(estoyEnOctava -1) * 13) ", posn,(12-nota +(estoyEnOctava -1) * 13)
                                        ...
                                        Else
                                             If pasoZona1=0 Then ' 15-05-2026
                                                  If Roll.trk(posn,(12-nota +(estoyEnOctava -1) * 13)).nota = 0 Or Roll.trk(posn,(12-nota +(estoyEnOctava -1) * 13)).dur = 182   Then
                                                       ...
                                                       ''           print #1, "ingreso a NUCLEO POSICION=POSN va al final siempre ", posicion
                                                       Exit Do
                                                  End If
                                             Else
                                                  If pasoZona1 > 0 Then ' 15-05-2026
                                                       posicion=posn
                                                       '182 el fin de archivo lo puedo pisar para seguir la secuencia O EL 183 fin del evento ojo!!!
                                                       ''            print #1, "ingreso a NUCLEO POSICION=POSN por PASOZON1 del usuraio no va al final ", posicion
                                                       Exit Do
                                                  End If
                                        ...
                                        If HabilitarMIDIIN =0 And  GrabarPenta=0  Then
                                             ...
                                             '  pmTk(ntk).posn =posn ' 383 un posn para cada pista 08-05-2026
                                             '  pmTk(ntk).MaxPos =posn +6' 15-05-2026
                                             '  MaxPos =posn +6' 15-05-2026
                                        End If
                                        ...
                                        If HabilitarMIDIIN > 0  And GrabarPenta=1  Then
                                             ...
                                             Else
                                                  posn = posn + 1
                                                  '' pmTk(ntk).posn =posn ' un posn para cada pista 08-05-2026 383
                                                  '' pmTk(ntk).MaxPos =posn +6' 15-05-2026
                                                  '' MaxPos =posn +6' 15-05-2026
                                        ...
                                        '--------------
                                   Loop
                                   ''Print #1,"SALIO DEL LOOP DE UBICACION DE POSN "
                                   '' fileflush(-1)
                                   ...
                                   Case Else
                                        ...
                                        ''TOCAR LA NOTA ..CANCELA CON ENTADA DE DATOS EN CANCION NUEVA Y PISTA NUEVA
                                        '----------
                                        ''Print #1," 3702 posn ";posn
                                        ''Print #1,"PianoNota),pmTk(0).canalsalida,pmTk(0).portout ";PianoNota,pmTk(0).canalsalida,pmTk(0).portout
                                        AbrirPort()
                                        
                                        
                                        '  If NuevaCancion=SI Then cancela siempre ahora no se porque mierda
                                        '  Else
                                        ...
                                        pmTk(0).vol=70
                                        noteon(cubyte(PianoNota),70,pmTk(0).canalsalida,pmTk(0).portout,1,1)
                                   ...
                                   If DURAUX <= 90 Then 'caso 1) no ligado, I, L, W etc, viene algo que termina
                                        ...
                                        If posnOffOld > 0 Then ' OK!! caso 4) previo llego un caso 2) ligado y luego ahora un 1) no ligado
                                             ...
                                             If (posn > NroCol + InicioDeLectura) Then
                                                  InicioDeLectura=InicioDeLectura + NroCol
                                             End If
                                             If mas=0 And pasoZona1=0 Then '19-12-2025
                                        ...
                                        Else ' OK! 1) viene unan nota on y termina DUR <= 90 solita
                                             ...
                                             ''Next j
                                             ''Print #1, "(NB,NA)12-nota +(estoyEnOctava -1) * 13 ",12-nota +(estoyEnOctava -1) * 13
                                             ''Print #1, "posnOff ",posnOff
                                             ''Print #1, "ubound 1 de Roll.trk ", UBound(Roll.trk, 1)
                                             ''Print #1, "lbound 1 de Roll.trk ", lBound(Roll.trk, 1)
                                   ...
                                   If nroPartesNota > 0 Then 'limpia entre el nacimiento y el muere de la duracion de la nota..eje kk
                                        ...
                                        nroPartesNota=0
                                   End If
                                   ''pmTk(ntk).MaxPos=MaxPos '' 383
                                   ''If CANCIONCARGADA=TRUE And MaxPosTope < MaxPos Then ' 07-05-2026 383
                                   ''   MaxPosTope=MaxPos ''383
                                   ''  EndIf
...
'' FALTA QUE CON EL NOMBREDE NOTA CTRL-N INSERTE O MODIFIQUE
               ...
               If (ScreenEvent(@e)) Then
                    ...
                    Case EVENT_KEY_PRESS    ' <======== KEY PRESS PULSO =====================================================
                         ' ********************************************************************************
                         If e.scancode = SC_TAB  And (instancia=ARG0_EN_LINEA Or instancia= ARG107_FICTICIO) And CANCIONCARGADA=TRUE   Or clickpista=1   Then
                              pulsotab=1
                              ''   thread3= threadcall TABTAB() '''GetCurrentThread()
                              '' esta table es distinta a la otra cual vale??
                              ' - 1: lowest
                         ...
                         End If
                         If e.scancode=SC_BACKSPACE  And COMEDIT <> ENTRADA_NOTAS Then
                              pulsotab= -1
                              backspace=1
                              If pasoZona1 > 0 Then
...
'-------------
                  PARAR_PLAY_MANUAL=SI
                         ...
                         If e.scancode = SC_X Then ' 81 <==== SC_X ...fix
                              ...
                              If nroClick=DesplegarMenuModifClickDerecho Then
                         ...
                         If e.scancode = SC_RIGHT Then
                              ...
                              Else
                                   ...
                                   If COMEDIT<>ENTRADA_NOTAS Then
                                        ...
                                        End If
                                   Else   '''ENTRADA_NOTAS
                                        If pasoZona1 > 0 And pasoZona1Old > 0 Then
                                             pasoZona1=pasoZona1 + (pasoZona1-pasoZona1Old)
                                        End If
                                   End If
                              End If
                              GetMouse mouseX, mouseY, , MouseButtons
                    ...
                    Case EVENT_KEY_REPEAT
                         If e.scancode=SC_BACKSPACE And backspace=0 And  COMEDIT <> ENTRADA_NOTAS Then
                              pulsotab= -1
                              backspace=1
                              If pasoZona1 > 0 Then
                                   pasoZona1=pasoZona1Old
                    ...
                    If (mouseX >= 36) And (mouseX <= 70) And (menuNro=PARAMETROS_ROLL Or menuNew=PARAMETROS_ROLL)  Then
                         ...
                         If MouseButtons And 1 And cierroedit= 0 Then ' no se si funciona mejor lo dejaremos un tiempo
                              ...
                              If s3 = 0  Then
                                   ...
                                   '      If CANCIONCARGADA=TRUE Then ''13-05-2026 tratamos de remedar una edicion aislada sin cancion
                                   '         MaxPos=pmTk(ntk).MaxPos ''13-05-2026 tomo el maxpos de esa pista
                                   '         posn=MaxPos-6  ''13-05-2026
                                   '       EndIf
                              ...
                              Else
                                   If s3=1 Then ' VIENE DE COMEDIT=TRUE PASAMOA A FALSE
                                        '        If CANCIONCARGADA=TRUE Then ''13-05-2026 volvemos a ala MKAxPosTope de toda la cancion
                                        '           MaxPos=maxposTope ''13-05-2026
                                        '           posn=MaxPos-6  ''13-05-2026
                                        '        EndIf
               ...
               If  mouseY > 50 Then '<=== delimitacion de area de trabajo
                    ...
                    If COMEDIT=LECTURA Then
                         ...
                         If MultiKey(SC_CONTROL) And MouseButtons And 2 Then 'yyy
                              ...
                              fillrectdraw(6,6,&hffffff) '  ERA 2,2 CON TICKS PASAMOS A 5 MNIMO TAMAÑO
                              ...
                              notabase =OpenSubMenu(hpopup1," Esta Nota Base es ...") ' si la nota elegida será Tonica 3era 5ta etc
                         ...
                         '
                         /'  PASOZONA 1 Y 2 LO MOVEMOS MAS ABAJO PARA QUE FUNCIONE PARA CUELQUIER COMMEDIT
                         ''' 15-05-2026
                    ...
                    If  COMEDIT<>LECTURA  Then
                         If  COMEDIT=MODIFICACION_INSERCION  Then
                              If MouseButtons And 1 Then
                                   ...
                                   Else
                                        curpos=curposClickDerecho '268-09-2025 wwwkkk
                                   End If
                         ...
                         End If
                         cierroedit=0
                         '---- MENU INSERCIONES NOTAS CON MENU DE MOUSE --no funca
                         If COMEDIT=MODIFICACION_INSERCION Or COMEDIT=ENTRADA_NOTAS Or COMEDIT=SOLO_MODIFICACION Then
                              If  MultiKey(SC_CONTROL) And (MouseButtons And 2)  Then
                                   ...
                                   menuMouse = 0
                                   nroClick=DesplegarMenuModifClickDerecho
                                   ...
                                   '  Print  #1, " ArmarMenuModif=TRUE"
                                   '  Print  #1," SeleccionarNuevaNota=FALSE"
                                   '  Print  #1," menuMouse = 0"
                                   '  Print  #1," nroClick=DesplegarMenuModifClickDerecho  "
                              ...
                              If  SeleccionarNuevaNota=FALSE And ArmarMenuModif=TRUE Then 'ESTADO: seleccionar comando
                                   If (mouseButtons And 1 )  And nroClick = DesplegarMenuModifClickDerecho  Then
                                        ArmarMenuModif=FALSE
                                        menumouse=0
                                        posinterna=0
                                        COMEDIT=MODIFICACION_INSERCION 'CTRL-M
                                        ' print #1, "------------------------------------------------------------"
                                        ' Print  #1,"(2) (mouseButtons And 1 ) And ArmarMenuModif=TRUE And nroClick = DesplegarMenuModifClickDerecho And COMEDIT=TRUE "
                                        ' Print  #1,  "And SeleccionarNuevaNota=FALSE "
                                        ' Print  #1,"ESTADO: seleccionar comando "
                                        ' Print  #1," ArmarMenuModif=FALSE"
                                        ' Print  #1," menumouse=0"
                                        ' Print  #1," posinterna=0"
                                        ' print #1,"posicion curpos MaxPos,posn ", posicion, curpos, MaxPos,posn
                                        
                                        ' Necesitamos mostrar el menu todavia  savemousex=0 : savemousey=0
                                        'seleccionamos verticalmente ,,,,
                                        nroClick=SeleccionarComandoClickIzquierdo
                              ...
                              If   ArmarMenuModif=FALSE Then
                                   If (mouseButtons And 1 )  And nroClick=SeleccionarComandoClickIzquierdo  Then
                                        savemousex=0 : savemousey=0 '
                                        ' ESTADO: PREPARA COMANDO
                                        ' Print #1, "------------------------------------------------------------"
                                        ' Print #1, "(3) (mouseButtons And 1 ) and ArmarMenuModif=FALSE And nroClick=SeleccionarComandoClickIzquierdo  And COMEDIT=TRUE "
                              ...
                              If (MouseButtons And 2)   Then ''<=== menu de duraciones para seleccionar con click
                                   ...
                                   SeleccionarNuevaNota=TRUE 'ESTADO: CALL MENU DURACIONES O CTRL-M
                                   ArmarMenuModif =FALSE
                                   savemousex=0 : savemousey=0 ''ACA NO ¿?
                                   VolverEntradaDatos=FALSE
                                   menuMouse = 0
                                   ...
                                   '   Print  #1," SeleccionarNuevaNota=TRUE "
                                   '   Print  #1," ArmarMenuModif =FALSE"
                                   '   Print  #1," savemousex=0 : savemousey=0 "
                                   '   Print  #1,"  VolverEntradaDatos=FALSE"
                                   '   Print  #1,"  menuMouse = 0"
                                   '   Print  #1,"  DUR=0"
                                   '   Print  #1,"  nroClick=DesplegarMenuModifClickDerecho "
                              ...
                              ' YA VUELVE OK
                              '******************************************************************************
                              '>>>>>>>>> EJECUCION COMANDOS MENU GRAFICO COMEDIT=MODIFICACION_INSERCION<<<<<<<
                              '*******************************************************************************
                              ' SEPULSO CTRL-P Y  CON ESTO SE VUELVE ,,FIX CON COMEDIT<>LECTURA SE PUEDE USAR CON CTRL-M Y ENTRADA_NOTAS. (CTRL-N NO LO USO NO SE SI PONERLO)
                              If  ArmarMenuModif=FALSE Then
                                   If (mouseButtons And 1 ) And  COMEDIT<>LECTURA  And modifmouse <> 3 Then ' ESTADO: SELECCIONA VolverEntradaDatos CTRL-P
                                        'Print #1, "------------------------------------------------------------"
                                        'Print  #1,"(5) MB1  And AModif=FALSE And CE=TRUE  And CVert = 1 "
                                        'Print  #1,"5->ESTADO: SELECCIONA VolverEntradaDatos CTRL-P"
                                        'Print  #1,"  VolverEntradaDatos=TRUE"
                                        'Print #1,"posicion curpos MaxPos,posn ", posicion, curpos, MaxPos,posn
                                        ' LA VolverEntradaDatos ES UN SOLO PASO A ENTRADA_DATOS
                                        ...
                                        If mousey <= usamousey -40  And mousey >= usamousey -60 Then
                                             If mousex >= usamousex -64 And mousex<= usamousex +86 Then
                                                  ...
                                                  ' Print  #1,"5-> ArmarMenuModif=FALSE    savemousex=0 : savemousey=0  nroClick=0"
                                   ...
                                   End If
                              End If
                              If ArmarMenuModif=FALSE And SeleccionarNuevaNota=TRUE Then ' ESTADO : SELECCIONA DURACION O CTRL-M o CTRL-P
                                   If (mouseButtons And 1 )  And nroClick = DesplegarMenuModifClickDerecho  Then
                                        SeleccionarNuevaNota=FALSE
                                        savemousex=0 : savemousey=0
                                        menuMouse = 0
                                        ' Print #1, "------------------------------------------------------------"
                                        ' Print  #1,"(6) (mouseButtons And 1 ) And SeleccionarNuevaNota=TRUE And nroClick = DesplegarMenuModifClickDerecho And COMEDIT<>LECTURA "
                                        ' Print   #1," 6->And ArmarMenuModif=FALSE Then ' ESTADO : SELECCIONA DURACION O CTRL-M"
                                        ' Print  #1,"(6)MB1  +d ANN=TRUE + NClick = 1 + CE=TRUE + ArmarMenuModif=FALSE"
                                        ' Print  #1,"(6)ESTADO : SELECCIONA DURACION O CTRL-M , nroClick ", nroClick
                                        ' Print  #1," 6 out-> SeleccionarNuevaNota=FALSE"
                                        ' Print  #1,"  savemousex=0 : savemousey=0"
                                        ' Print  #1,"  menuMouse = 0"
                                        ...
                                        ' determinmos duracion clickeada o seleccionada graficamente
                                        nroClick=ObtenerDuracion1erClickIzquierdo
                                        If mousey >= usamousey +30  And mousey <= usamousey + 44 Then 'CTRL-M
                                             ...
                                             End If
                                        End If
                                        '   Print #1,"ppppp MOUSEY ";mousey, "usamousey ";usamousey
                                        If mousey <= usamousey -30  And mousey >= usamousey - 60 Then 'CTRL-P
                                             If mousex >= usamousex -55 And mousex<= usamousex +102 Then
                                                  ...
                                                  ''  ArmarMenuModif=TRUE jmg elmenu no debe aparecer hasta dar ctrl-click derecho
                                                  '  Print #1,"6A ctrl-P ->COMEDIT=ENTRADA_DATOS : agregarNota=0:  menuMouse = 0 "
                                                  '  Print #1,"6A-> ArmarMenuModif=TRUE"
                                                  Exit Do
                                             End If
                                        End If
                                        ...
                                        If mousex >= usamousex +110 And  mousex <= usamousex +130 Then ' H en +120
                                             DUR=8
                                        End If
                                        curpos=curposClickDErecho ' REPONEMOS EL CURPOS AL DE LA NOTA A MODIFICAR
                                        
                                   End If
                                   curpos=curposClickDErecho
                              End If
                              
                              If SeleccionarNuevaNota=FALSE And ArmarMenuModif=FALSE Then
                                   If DUR > 0 And nsE > 0 And nroClick=ObtenerDuracion1erClickIzquierdo  And modifmouse<> 3 Then ' ESTADO INGRESA O MODIFICA 1ER NOTA
                                        nota=nsE   ''<== 1er nota ingresada para la duracion y nota elegida
                                        nroClick=0
                                        ' print #1, "------------------------------------------------------------"
                                        ' Print  #1," DUR > 0 And nsE > 0 And nroClick=DesplegarMenuModifClickDerecho And SeleccionarNuevaNota=FALSE and COMEDIT<>LECTURA "
                                        ' Print  #1," And ArmarMenuModif=FALSE "
                              ...
                              If ArmarMenuModif=FALSE And SeleccionarNuevaNota=FALSE And octavaEdicion = estoyEnOctava Then
                                   ...
                                   If (mouseButtons And 1) And (DUR > 0) And (nsE > 0) And modifmouse<> 3  And s11=0 Then
                                        ...
                                        If curposClickDErecho > 0 Then
                                             curpos=curposClickDErecho '26-09-2025
                                        Else
                              ...
                              End If
                         EndIf ' FINN COMEDIT=MODIFICACION_INSERCION
                    EndIf ' FIN <========COMEDIT<>LECTURA
                    ' menu contextual
...
Sub TABTAB ()
     ...
     Else
          ...
          dur=0
          If ntk=0 Then ntk=1
          maxpos=pmTk(ntk).maxpos ' ok individual
          ...
          ''If CANCIONCARGADA=TRUE And COMEDIT=ENTRADA_NOTAS Then ' 07-05-2026 , para poder editar desde eltamaño de esa pista
          '''posn=pmTk(ntk).MaxPos -6
          ''If posn < 2 Then posn=2 EndIf
          ''EndIf
          Print #1," TABTAB LLAMA A RECALCOMPAS  "
          '    If pmTk(ntk).MaxPos=MaxPosTope Then
