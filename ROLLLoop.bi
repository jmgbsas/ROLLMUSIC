...
' OPCION NO MOSTRAR SILENCIOS,.,,,IF SILENCIO=0 ...
 ' filtro1=128 :filtro2=144
  If dato1 > 0  And DURk >0  Then 'And (dato1<>filtro1 Or dato1<>filtro2) Then 'And cnf=0  Then
   '  t2k=Timer
...
For ij= 1 To numduras
 'Print #1,"GrabarPenta duras(ij) "; GrabarPenta; " "; duras(ij)
  ...
  EndIf
   ...
   If ayudaNuevaNota=FALSE And ayudaModif=FALSE Then
      If DUR > 0 And nsE > 0 And nroClick = 1 And modifmouse<> 3 Then ' ESTADO INGRESA O MODIFICA 1ER NOTA
         ...
         nroClick=0
 ' print #1, "------------------------------------------------------------"
 ' Print  #1," DUR > 0 And nsE > 0 And nroClick = 1 And ayudaNuevaNota=FALSE and COMEDIT=TRUE "
