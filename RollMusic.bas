...
' --------------------------------------------
nroversion="0.360 GRABA ROLL *.MID TIPO 0 CON MAS EFECTOS PAN, ECO, CORO, VOLUMEN.. "
...
' ---------------------------------------------------------------------
' esta version no ser� compatible con las anteriores de rollmusic sin ticks se agrego por ahora
