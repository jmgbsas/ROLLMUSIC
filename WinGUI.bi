...
' - Pim Scheffers: Control_CreateFont, Control_SetFont, Control_DeleteFont.
'And thanks to all who contributed to the discusions on the project site on
'freebasic.net  
'--------------------------------------------------------------------------
...
''If PeekMessage(@msg, 0, 0, 0,0) <> 0 Then
